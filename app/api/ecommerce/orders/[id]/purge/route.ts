...
// DELETE|POST /api/ecommerce/orders/[id]/purge → HARD delete (permanent removal from trash).
// Irreversible. data.write. Explicit alias for DELETE /api/ecommerce/orders/[id]?purge=1.
