...
// DELETE|POST /api/ecommerce/carts/[id]/purge → HARD delete (permanent removal from trash).
// Irreversible. data.write. Explicit alias for DELETE /api/ecommerce/carts/[id]?purge=1.
