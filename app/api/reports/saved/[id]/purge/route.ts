...
// DELETE|POST /api/reports/saved/[id]/purge → HARD delete (permanent removal from trash).
// Irreversible. data.write. Explicit alias for DELETE /api/reports/saved/[id]?purge=1.
