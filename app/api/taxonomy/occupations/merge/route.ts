...
// POST /api/taxonomy/occupations/merge → merge fromId INTO toId (re-point refs,
...
export async function POST(req: Request) {
  ...
  return handle(async () => {
    ...
    return ok(await taxonomyService.mergeOccupation(g.ctx, fromId, toId));
  }, "api/taxonomy/occupations/merge POST");
}
