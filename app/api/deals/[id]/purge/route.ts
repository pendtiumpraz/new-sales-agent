...
// DELETE|POST /api/deals/[id]/purge → HARD delete (permanent removal from trash,
// cascades to activities). Irreversible. data.write. Explicit alias for
// `DELETE /api/deals/[id]?purge=1`.
