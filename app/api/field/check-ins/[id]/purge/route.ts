...
// DELETE|POST /api/field/check-ins/[id]/purge → HARD delete (permanent removal from trash).
// Irreversible. data.write. Explicit alias for DELETE /api/field/check-ins/[id]?purge=1.
