...
// DELETE|POST /api/marketplace/integrations/[id]/purge → HARD delete (permanent removal from trash).
// Irreversible. data.write. Explicit alias for DELETE /api/marketplace/integrations/[id]?purge=1.
async function purge(_req: Request, { params }: Ctx) {
  ...
  }, "api/marketplace/integrations/[id]/purge");
}
